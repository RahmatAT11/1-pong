...
public class Trajectory : MonoBehaviour
{
    ...
    void Update()
    {
        // Inisiasi status pantulan lintasan, yang hanya akan ditampilkan jika lintasan
        // bertumbukan dengan object tertentu
        bool drawBallAtCollision = false;
        
        // Titik tumbukan yang digeser, untuk menggambar ballAtCollision
        Vector2 offsetHitPoint = new Vector2();
        
        // Tentukan titik tumbukan dengan deteksi titik tumbukan lingkaran
        ...
        foreach (RaycastHit2D circleCastHit2D in circleCastHit2DArray)
        {
            ...
            {
                // Garis lintasan akan digambar dari titik tengah bola saat ini ke titik tengah bola
                // pada saat tumbukan, yaitu sebuah titik yang di-offset dari titik tumbukan berdasar
                // vektor normal titik tersebut sebesar jari-jari bola.
                ...
                // Gambar garis lintasan dari titik tengah bola saat ini ke titik tengah bola pada saat
                // bertumbukan
                DottedLine.DottedLine.Instance.DrawDottedLine(
                    ball.transform.position, offsetHitPoint);
